// Buit using Reference https://liveblocks.io/docs/api-reference/liveblocks-react#createRoomContext
...
const createClient: CreateClient = require("@liveblocks/client").createClient;
